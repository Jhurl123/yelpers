...
module.exports = "<div class=\"c-alert\" [ngClass]=\"{'successAlert' : alertType === 'success'}\">\n  <p>{{ alertText }}</p>\n</div>\n"
...
module.exports = "<div class=\"c-review\">\n  <div class=\"c-review_inner\">\n    <div class=\"c-review_image-container\">\n      <a routerLink=\"/user/:id\">\n        <img class=\"c-review_image\" src=\"../../../../assets/images/user-placeholder.png\">\n      </a>\n      <div class=\"c-review_user-name\">\n        <a routerLink=\"/user/:id\">{{ review.user.name}}</a>\n      </div>\n    </div>\n    <div class=\"c-review_body\">\n      <star-rating value=\" {{review.rating}}\" checkedcolor=\"#FEC011\" uncheckedcolor=\"#e7e2e2\" size=\"24px\"  readonly=\"true\"></star-rating>\n      <span>{{ review.time_created }}</span>\n      <div class=\"c-review_text\">\n        {{ review.text }}\n      </div>\n    </div>\n  </div>\n</div>\n"
...
module.exports = "<div class=\"c-review-list\" *ngIf=\"reviews\">\n  <div class=\"col-xs-12 c-review-list_container\">\n    <h2 class=\"c-review-list_header\">Reviews</h2>\n    <div class=\"c-reviews-list_review\" *ngFor=\"let review of reviews\">\n      <app-review [review]=\"review\"></app-review>\n    </div>\n    <div class=\"c-reviews-list_input\">\n      <app-review-input></app-review-input>\n    </div>\n  </div>\n</div>\n"
...
/***/ "./node_modules/raw-loader/index.js!./src/app/reviews/review-input/review-input.component.html":
/*!********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/reviews/review-input/review-input.component.html ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<div class=\"row l-content-container c-signup\">\n  <div class=\"columns small-12\">\n    <div class=\"c-signup_container\">\n      <h2>Sign Up</h2>\n      <form [formGroup]=\"registerForm\" (ngSubmit)=\"onSubmit()\">\n          <div class=\"form-group\">\n              <label for=\"firstName\">First Name</label>\n              <input type=\"text\" formControlName=\"firstName\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.firstName.errors }\" />\n              <div *ngIf=\"submitted && f.firstName.errors\" class=\"invalid-feedback\">\n                  <div *ngIf=\"f.firstName.errors.required\">***First Name is required***</div>\n              </div>\n          </div>\n          <div class=\"form-group\">\n              <label for=\"lastName\">Last Name</label>\n              <input type=\"text\" formControlName=\"lastName\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.lastName.errors }\" />\n              <div *ngIf=\"submitted && f.lastName.errors\" class=\"invalid-feedback\">\n                  <div *ngIf=\"f.lastName.errors.required\">***Last Name is required***</div>\n              </div>\n          </div>\n          <div class=\"form-group\">\n              <label for=\"emailAddress\">Email Address</label>\n              <input\n                type=\"text\"\n                formControlName=\"emailAddress\"\n                class=\"form-control\"\n                [ngClass]=\"{ 'is-invalid': submitted && f.emailAddress.errors }\"\n              />\n              <div *ngIf=\"submitted && f.emailAddress.errors\" class=\"invalid-feedback\">\n                  <div *ngIf=\"f.emailAddress.errors.required\">***Email Address is required***</div>\n              </div>\n              <div *ngIf=\"submitted && f.emailAddress.errors\" class=\"invalid-feedback\">\n                <div *ngIf=\"f.emailAddress.errors.email\">***Email Address is incorrect format***</div>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"birthDate\">Birth Date (optional)</label>\n              <dp-date-picker\n                [config]=\"datePickerConfig\"\n                formControlName=\"birthDate\"\n              >\n              </dp-date-picker>\n            </div>\n          </div>\n          <div formGroupName=\"passwords\">\n            <div class=\"form-group\">\n              <label for=\"password\">Password</label>\n              <input type=\"password\" formControlName=\"password\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && passwords.controls['password'].errors }\" />\n              <div *ngIf=\"submitted && passwords.controls['password'].errors\" class=\"invalid-feedback\">\n                <div *ngIf=\"passwords.controls['password'].errors.required\">***Password is required***</div>\n                <div *ngIf=\"passwords.controls['password'].errors.minlength\">***Password must be at least 6 characters***</div>\n                <div *ngIf=\"passwords.controls['password'].errors.noUpper\">***Password must contain an uppercase letter!***</div>\n              </div>\n            </div>\n            <div class=\"form-group\">\n              <label for=\"confirmPassword\">Confirm Password</label>\n              <input type=\"password\" formControlName=\"confirmPassword\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && passwords.controls['confirmPassword'].errors }\" />\n              <div *ngIf=\"submitted && passwords.controls['confirmPassword'].errors\" class=\"invalid-feedback\">\n                  <div *ngIf=\"passwords.controls['confirmPassword'].errors.required\">***Password is required***</div>\n                  <div *ngIf=\"passwords.controls['confirmPassword'].errors.minlength\">***Password must be at least 6 characters***</div>\n                  <div *ngIf=\"passwords.controls['confirmPassword'].errors.passwordMatch\">***Passwords don't match!***</div>\n              </div>\n            </div>\n          </div>\n          <div class=\"form-group\">\n              <button [disabled]=\"loading\" class=\"btn btn-primary alt\" type=\"submit\">\n                  <span *ngIf=\"loading\" class=\"spinner-border spinner-border-sm mr-1\"></span>\n                  Register\n              </button>\n              <button routerLink=\"/login\" class=\"btn btn-link hollow\">Login</button>\n          </div>\n      </form>\n    </div>\n  </div>\n</div>\n"
...
var auth_guard_1 = __webpack_require__(/*! ./helpers/auth.guard */ "./src/app/helpers/auth.guard.ts");
var home_component_1 = __webpack_require__(/*! @/views/home/home.component */ "./src/app/views/home/home.component.ts");
var hotels_component_1 = __webpack_require__(/*! @/views/hotels/hotels.component */ "./src/app/views/hotels/hotels.component.ts");
var restaurants_component_1 = __webpack_require__(/*! @/views/restaurants/restaurants.component */ "./src/app/views/restaurants/restaurants.component.ts");
var signup_component_1 = __webpack_require__(/*! @/views/signup/signup.component */ "./src/app/views/signup/signup.component.ts");
var login_component_1 = __webpack_require__(/*! @/views/login/login.component */ "./src/app/views/login/login.component.ts");
var my_account_component_1 = __webpack_require__(/*! @/views/my-account/my-account.component */ "./src/app/views/my-account/my-account.component.ts");
var things_to_do_component_1 = __webpack_require__(/*! @/views/things-to-do/things-to-do.component */ "./src/app/views/things-to-do/things-to-do.component.ts");
var home_services_component_1 = __webpack_require__(/*! @/views/home-services/home-services.component */ "./src/app/views/home-services/home-services.component.ts");
var search_results_component_1 = __webpack_require__(/*! @/views/search-results/search-results.component */ "./src/app/views/search-results/search-results.component.ts");
var single_business_component_1 = __webpack_require__(/*! @/views/single-business/single-business.component */ "./src/app/views/single-business/single-business.component.ts");
var routes = [
    {
        path: 'home',
    ...
    {
        path: 'home-services',
        component: home_services_component_1.HomeServicesComponent
    },
    {
        path: 'restaurants',
    ...
    {
        path: 'business/:id',
        component: single_business_component_1.SingleBusinessComponent
    }
];
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var viewport_sizing_service_1 = __webpack_require__(/*! @/services/viewport-sizing/viewport-sizing.service */ "./src/app/services/viewport-sizing/viewport-sizing.service.ts");
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.ctorParameters = function () { return [
        { type: viewport_sizing_service_1.ViewportSizingService }
    ]; };
    tslib_1.__decorate([
...
var jwt_interceptor_1 = __webpack_require__(/*! @/helpers/jwt.interceptor */ "./src/app/helpers/jwt.interceptor.ts");
var error_interceptor_1 = __webpack_require__(/*! @/helpers/error.interceptor */ "./src/app/helpers/error.interceptor.ts");
var app_routing_module_1 = __webpack_require__(/*! ./app-routing.module */ "./src/app/app-routing.module.ts");
var app_component_1 = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
var top_header_component_1 = __webpack_require__(/*! @/components/top-header/top-header.component */ "./src/app/components/top-header/top-header.component.ts");
var slide_menu_component_1 = __webpack_require__(/*! ./components/slide-menu/slide-menu.component */ "./src/app/components/slide-menu/slide-menu.component.ts");
var search_component_1 = __webpack_require__(/*! ./components/slide-menu/search/search.component */ "./src/app/components/slide-menu/search/search.component.ts");
var mobile_logo_component_1 = __webpack_require__(/*! ./components/slide-menu/mobile-logo/mobile-logo.component */ "./src/app/components/slide-menu/mobile-logo/mobile-logo.component.ts");
var mobile_nav_component_1 = __webpack_require__(/*! ./components/slide-menu/mobile-nav/mobile-nav.component */ "./src/app/components/slide-menu/mobile-nav/mobile-nav.component.ts");
var home_component_1 = __webpack_require__(/*! ./views/home/home.component */ "./src/app/views/home/home.component.ts");
var signup_component_1 = __webpack_require__(/*! ./views/signup/signup.component */ "./src/app/views/signup/signup.component.ts");
var login_component_1 = __webpack_require__(/*! ./views/login/login.component */ "./src/app/views/login/login.component.ts");
var restaurants_component_1 = __webpack_require__(/*! ./views/restaurants/restaurants.component */ "./src/app/views/restaurants/restaurants.component.ts");
...
var things_to_do_component_1 = __webpack_require__(/*! ./views/things-to-do/things-to-do.component */ "./src/app/views/things-to-do/things-to-do.component.ts");
var home_services_component_1 = __webpack_require__(/*! ./views/home-services/home-services.component */ "./src/app/views/home-services/home-services.component.ts");
var main_search_container_component_1 = __webpack_require__(/*! ./components/main-search-container/main-search-container.component */ "./src/app/components/main-search-container/main-search-container.component.ts");
var main_search_input_component_1 = __webpack_require__(/*! ./components/main-search-input/main-search-input.component */ "./src/app/components/main-search-input/main-search-input.component.ts");
var categories_select_component_1 = __webpack_require__(/*! ./components/categories-select/categories-select.component */ "./src/app/components/categories-select/categories-select.component.ts");
var location_select_component_1 = __webpack_require__(/*! ./components/location-select/location-select.component */ "./src/app/components/location-select/location-select.component.ts");
var hero_image_component_1 = __webpack_require__(/*! ./components/hero-image/hero-image.component */ "./src/app/components/hero-image/hero-image.component.ts");
var rand_nearby_component_1 = __webpack_require__(/*! ./components/rand-nearby/rand-nearby.component */ "./src/app/components/rand-nearby/rand-nearby.component.ts");
var business_card_component_1 = __webpack_require__(/*! ./components/business-card/business-card.component */ "./src/app/components/business-card/business-card.component.ts");
var content_row_component_1 = __webpack_require__(/*! ./components/content-row/content-row.component */ "./src/app/components/content-row/content-row.component.ts");
var tabs_component_1 = __webpack_require__(/*! ./components/tabs/tabs.component */ "./src/app/components/tabs/tabs.component.ts");
var tabs_section_component_1 = __webpack_require__(/*! ./components/tabs/tabs-section/tabs-section.component */ "./src/app/components/tabs/tabs-section/tabs-section.component.ts");
var tabs_body_component_1 = __webpack_require__(/*! ./components/tabs/tabs-body/tabs-body.component */ "./src/app/components/tabs/tabs-body/tabs-body.component.ts");
var tab_component_1 = __webpack_require__(/*! ./components/tabs/tab/tab.component */ "./src/app/components/tabs/tab/tab.component.ts");
var two_column_content_component_1 = __webpack_require__(/*! ./components/two-column-content/two-column-content.component */ "./src/app/components/two-column-content/two-column-content.component.ts");
var image_slider_component_1 = __webpack_require__(/*! ./components/image-slider/image-slider.component */ "./src/app/components/image-slider/image-slider.component.ts");
var single_business_component_1 = __webpack_require__(/*! ./views/single-business/single-business.component */ "./src/app/views/single-business/single-business.component.ts");
var css_spinner_component_1 = __webpack_require__(/*! ./components/css-spinner/css-spinner.component */ "./src/app/components/css-spinner/css-spinner.component.ts");
// Import Providers
var data_service_1 = __webpack_require__(/*! ./services/data/data.service */ "./src/app/services/data/data.service.ts");
...
// Dependencies
var ng_starrating_1 = __webpack_require__(/*! ng-starrating */ "./node_modules/ng-starrating/fesm5/ng-starrating.js");
var ngx_pagination_1 = __webpack_require__(/*! ngx-pagination */ "./node_modules/ngx-pagination/dist/ngx-pagination.js"); // <-- import the module
...
var ngx_lightbox_1 = __webpack_require__(/*! ngx-lightbox */ "./node_modules/ngx-lightbox/index.js");
var reviews_list_component_1 = __webpack_require__(/*! ./components/reviews/reviews-list/reviews-list.component */ "./src/app/components/reviews/reviews-list/reviews-list.component.ts");
var review_component_1 = __webpack_require__(/*! ./components/reviews/review/review.component */ "./src/app/components/reviews/review/review.component.ts");
var ng2_date_picker_1 = __webpack_require__(/*! ng2-date-picker */ "./node_modules/ng2-date-picker/fesm5/ng2-date-picker.js");
var alert_component_1 = __webpack_require__(/*! ./components/alert/alert.component */ "./src/app/components/alert/alert.component.ts");
var review_input_component_1 = __webpack_require__(/*! ./reviews/review-input/review-input.component */ "./src/app/reviews/review-input/review-input.component.ts");
    ...
    AppModule = tslib_1.__decorate([
        core_1.NgModule({
            declarations: [
                ...
                slide_menu_component_1.SlideMenuComponent,
                search_component_1.SearchComponent,
                mobile_logo_component_1.MobileLogoComponent,
                mobile_nav_component_1.MobileNavComponent,
                ...
                things_to_do_component_1.ThingsToDoComponent,
                home_services_component_1.HomeServicesComponent,
                main_search_container_component_1.MainSearchContainerComponent,
                main_search_input_component_1.MainSearchInputComponent,
                categories_select_component_1.CategoriesSelectComponent,
                location_select_component_1.LocationSelectComponent,
                hero_image_component_1.HeroImageComponent,
                rand_nearby_component_1.RandNearbyComponent,
                business_card_component_1.BusinessCardComponent,
                content_row_component_1.ContentRowComponent,
                tabs_component_1.TabsComponent,
                tabs_section_component_1.TabsSectionComponent,
                tabs_body_component_1.TabsBodyComponent,
                tab_component_1.TabComponent,
                two_column_content_component_1.TwoColumnContentComponent,
                css_spinner_component_1.CssSpinnerComponent,
                single_business_component_1.SingleBusinessComponent,
                ...
                review_input_component_1.ReviewInputComponent
            ],
            imports: [
...
module.exports = ".successAlert {\n  color: #155724;\n  background-color: #d4edda;\n  border-color: #c3e6cb;\n}\n\n.c-alert {\n  position: relative;\n  padding: 0.75rem 1.25rem;\n  margin-bottom: 1rem;\n  border: 1px solid transparent;\n  border-radius: 0.25rem;\n  color: #721c24;\n  background-color: #f8d7da;\n  border-color: #f5c6cb;\n}\n\n.c-alert p {\n  margin-bottom: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AlertComponent = /** @class */ (function () {
    ...
    tslib_1.__decorate([
        core_1.Input('alertType')
    ], AlertComponent.prototype, "alertType", void 0);
    tslib_1.__decorate([
        core_1.Input('alertText')
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var distance_service_1 = __webpack_require__(/*! @/services/distance.service */ "./src/app/services/distance.service.ts");
var BusinessCardComponent = /** @class */ (function () {
    ...
    BusinessCardComponent.ctorParameters = function () { return [
        { type: distance_service_1.DistanceService }
    ]; };
    tslib_1.__decorate([
        core_1.Input()
    ], BusinessCardComponent.prototype, "business", void 0);
    BusinessCardComponent = tslib_1.__decorate([
        core_1.Component({
...
var CategoriesSelectComponent = /** @class */ (function () {
    ...
    CategoriesSelectComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.CategoriesSelectComponent = CategoriesSelectComponent;
...
var ContentRowComponent = /** @class */ (function () {
    ...
    ContentRowComponent = tslib_1.__decorate([
        core_1.Component({
...
var CssSpinnerComponent = /** @class */ (function () {
    ...
    CssSpinnerComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.CssSpinnerComponent = CssSpinnerComponent;
...
var HeroImageComponent = /** @class */ (function () {
    ...
    HeroImageComponent = tslib_1.__decorate([
        core_1.Component({
...
var ImageSliderComponent = /** @class */ (function () {
    ...
    ImageSliderComponent = tslib_1.__decorate([
        core_1.Component({
...
var LocationSelectComponent = /** @class */ (function () {
    ...
    LocationSelectComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.LocationSelectComponent = LocationSelectComponent;
...
var router_1 = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var data_service_1 = __webpack_require__(/*! @/services/data/data.service */ "./src/app/services/data/data.service.ts");
var yelp_service_1 = __webpack_require__(/*! @/services/yelp.service */ "./src/app/services/yelp.service.ts");
var MainSearchContainerComponent = /** @class */ (function () {
    ...
    MainSearchContainerComponent.prototype.ngOnInit = function () {
        ...
        this.searchForm = this.formBuilder.group({
            SearchTerms: ['', forms_1.Validators.required],
    ...
    MainSearchContainerComponent.prototype.onSubmit = function (form) {
        ...
        var query = this.query.trim(), location = this.location;
        if (!form.valid) {
            if (!query) {
    ...
    MainSearchContainerComponent.ctorParameters = function () { return [
        ...
        { type: yelp_service_1.YelpService },
        { type: data_service_1.DataService },
        { type: router_1.Router },
        { type: router_1.ActivatedRoute }
    ]; };
    MainSearchContainerComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.MainSearchContainerComponent = MainSearchContainerComponent;
...
var MainSearchInputComponent = /** @class */ (function () {
    ...
    MainSearchInputComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.MainSearchInputComponent = MainSearchInputComponent;
...
var RandNearbyComponent = /** @class */ (function () {
    ...
    RandNearbyComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.RandNearbyComponent = RandNearbyComponent;
...
module.exports = ".c-review {\n  background: #ffffff;\n  border: 1px solid #cac5c5;\n  border-radius: 6px;\n  margin-bottom: 2rem;\n  padding: 0.5rem;\n  padding-left: 0;\n}\n.c-review_inner {\n  display: flex;\n  flex-direction: row;\n}\n.c-review_image {\n  max-width: 75px;\n  margin-bottom: 0.25rem;\n  width: 100%;\n}\n.c-review_image-container {\n  min-width: 125px;\n  padding: 0.5rem 1rem;\n  padding-left: 0;\n  text-align: center;\n  width: 25%;\n}\n.c-review_text {\n  padding-right: 1rem;\n}\n.c-review ::ng-deep star-rating > div {\n  display: inline;\n  margin-right: 1rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".c-review-list {\n  padding: 2rem 0;\n}\n.c-review-list_container {\n  margin: 0 auto;\n  max-width: 768px;\n}\n@media screen and (max-width: 768px) {\n  .c-review-list_container {\n    padding: 0 1rem;\n  }\n}\n.c-review-list_header {\n  color: #d32323;\n  margin-bottom: 1.25rem;\n}\n@media screen and (max-width: 768px) {\n  .c-review-list_header {\n    margin-bottom: 0.75rem;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ReviewsListComponent = /** @class */ (function () {
    ...
    ReviewsListComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () {
    ...
    ], ReviewsListComponent.prototype, "reviews", void 0);
    ReviewsListComponent = tslib_1.__decorate([
        core_1.Component({
...
var MobileLogoComponent = /** @class */ (function () {
    ...
    MobileLogoComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.MobileLogoComponent = MobileLogoComponent;
...
module.exports = ".c-mobile-nav {\n  padding-top: 3em;\n  margin: 0;\n  text-align: center;\n}\n.c-mobile-nav_container {\n  align-items: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  padding-bottom: 4rem;\n}\n.c-mobile-nav_list-item {\n  color: #fefefe;\n  font-size: 1.2em;\n  list-style-type: none;\n  padding: 0.5em;\n}\n.c-mobile-nav_list-item a {\n  color: #fefefe;\n  position: relative;\n  padding-bottom: 7px;\n}\n.c-mobile-nav_list-item a:after {\n  position: absolute;\n  top: 100%;\n  left: 0;\n  width: 100%;\n  height: 3px;\n  background: #fff;\n  content: \"\";\n  opacity: 0;\n  transition: height 0.3s, opacity 0.3s, transform 0.3s;\n  transform: translateY(-10px);\n}\n.c-mobile-nav_list-item a:hover:after {\n  opacity: 1;\n  transform: translateY(0px);\n}\n.c-mobile-nav_account-controls {\n  margin: 0;\n}\n.c-mobile-nav_account-controls a {\n  margin: 0 0.5em;\n}\n.c-mobile-nav_account-button {\n  color: #fefefe;\n  display: inline-block;\n  padding: 0.85em;\n  padding-bottom: 0.5em;\n}\n.c-mobile-nav_account-login {\n  margin: 0;\n  margin-top: 1em;\n  padding: 0.25 1em;\n  color: #d32323;\n  background-color: #fefefe;\n  border-radius: 6px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MobileNavComponent = /** @class */ (function () {
    ...
    MobileNavComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.MobileNavComponent = MobileNavComponent;
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.toggleInput = function (event) {
    };
...
module.exports = ".c-slide-menu {\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 100%;\n  bottom: 0;\n  left: 0;\n  background-color: red;\n  transition: all 0.8s ease-in-out;\n  color: green;\n  transform: translateX(-100%);\n  z-index: 1000;\n  height: 100vh;\n  overflow-y: auto;\n}\n.c-slide-menu--open {\n  transform: translateX(0%);\n}\n.c-slide-menu_inner {\n  align-items: center;\n  display: flex;\n  justify-content: space-between;\n  padding: 1em 2em;\n}\n.c-slide-menu_close {\n  color: #fefefe;\n  cursor: pointer;\n  font-size: 22px;\n  font-weight: bold;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TabComponent = /** @class */ (function () {
    function TabComponent(sanitizer) {
        ...
        this.toggleTab = new core_1.EventEmitter();
...
var TabsBodyComponent = /** @class */ (function () {
    ...
    TabsBodyComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.TabsBodyComponent = TabsBodyComponent;
...
var TabsSectionComponent = /** @class */ (function () {
    ...
    TabsSectionComponent = tslib_1.__decorate([
        core_1.Component({
...
var tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var svgLoader = __webpack_require__(/*! ../../../assets/images/svg-store.json */ "./src/assets/images/svg-store.json");
var TabsComponent = /** @class */ (function () {
    function TabsComponent() {
        this.svgObject = svgLoader;
...
var TopHeaderComponent = /** @class */ (function () {
    function TopHeaderComponent(authService, route, router) {
        this.authService = authService;
        this.route = route;
        this.router = router;
        this.display = false;
    ...
    TopHeaderComponent.prototype.checkLoginStatus = function () {
        ...
        this.authService.currentUser.subscribe(function (result) {
            if (result) {
                _this.loggedIn = !_this.loggedIn;
            }
        });
...
var TwoColumnContentComponent = /** @class */ (function () {
    ...
    TwoColumnContentComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.TwoColumnContentComponent = TwoColumnContentComponent;
...
/***/ "./src/app/reviews/review-input/review-input.component.scss":
/*!******************************************************************!*\
  !*** ./src/app/reviews/review-input/review-input.component.scss ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = ".c-input textarea {\n  box-shadow: inset 2px 2px 2px 0px #dddddd;\n  font-size: 1.15rem;\n  width: 100%;\n  margin-top: 0.75rem;\n}\n.c-input h4 {\n  color: #d32323;\n  font-size: 1.6em;\n}\n.c-input ::ng-deep star-rating > div {\n  display: inline;\n}\n.c-input_rating-container {\n  display: flex;\n  align-items: center;\n}\n.c-input_rating-container span {\n  font-size: 14px;\n  color: #d32323;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/reviews/review-input/review-input.component.ts":
/*!****************************************************************!*\
  !*** ./src/app/reviews/review-input/review-input.component.ts ***!
  \****************************************************************/
/*! no static exports found */
...
var ReviewInputComponent = /** @class */ (function () {
    ...
    ReviewInputComponent = tslib_1.__decorate([
        core_1.Component({
            ...
            template: __webpack_require__(/*! raw-loader!./review-input.component.html */ "./node_modules/raw-loader/index.js!./src/app/reviews/review-input/review-input.component.html"),
            styles: [__webpack_require__(/*! ./review-input.component.scss */ "./src/app/reviews/review-input/review-input.component.scss")]
        })
    ], ReviewInputComponent);
    return ReviewInputComponent;
}());
exports.ReviewInputComponent = ReviewInputComponent;
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (emailAddress, password) {
        var _this = this;
        var config = '/api/account/login';
        return this.http.post(config, { emailAddress: emailAddress, password: password })
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.businessSource = new rxjs_1.BehaviorSubject({});
...
var DistanceService = /** @class */ (function () {
    ...
    DistanceService = tslib_1.__decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], DistanceService);
...
var ReviewService = /** @class */ (function () {
    function ReviewService(authenticationService, http) {
        this.authenticationService = authenticationService;
        this.http = http;
        this.currentUser = this.authenticationService.currentUserValue;
    }
    ReviewService.prototype.handleError = function (error, context) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.handleError = function (error, context) {
        if (error === void 0) { error = ''; }
        if (context === void 0) { context = ''; }
        console.log(error);
        return rxjs_1.throwError(error);
    };
    UserService.prototype.registerUser = function (userForm) {
        var config = "/api/account/signup";
...
var ViewportSizingService = /** @class */ (function () {
    ...
    ViewportSizingService = tslib_1.__decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
...
exports.ViewportSizingService = ViewportSizingService;
...
var YelpService = /** @class */ (function () {
    ...
    YelpService.prototype.getReviews = function (id, url) {
        var config = '/api/yelp/scrape-reviews';
        var reviewObject = {
            id: id,
            url: url
        };
    ...
    YelpService = tslib_1.__decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], YelpService);
...
/***/ "./src/app/validators/formatPassword.validator.ts":
/*!********************************************************!*\
  !*** ./src/app/validators/formatPassword.validator.ts ***!
  \********************************************************/
/*! no static exports found */
...
function passwordFormatValidator(control) {
    ...
    var isUpperCase = function (string) { return /^[A-Z]*$/.test(password); };
    var _loop_1 = function (i) {
        var isUpperCase_1 = function (string) { return /^[A-Z]*$/.test(password[i]); };
        if (isUpperCase_1(password)) {
...
exports.passwordFormatValidator = passwordFormatValidator;
...
var HomeServicesComponent = /** @class */ (function () {
    ...
    HomeServicesComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.HomeServicesComponent = HomeServicesComponent;
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent = tslib_1.__decorate([
        core_1.Component({ template: __webpack_require__(/*! raw-loader!./home.component.html */ "./node_modules/raw-loader/index.js!./src/app/views/home/home.component.html") })
    ], HomeComponent);
...
module.exports = ".c-login-container {\n  max-width: 480px;\n  margin: 0 auto;\n  padding-top: 5em;\n}\n@media (max-width: 768px) {\n  .c-login-container {\n    padding: 3em 20px 0 20px;\n  }\n}\n.c-login input {\n  margin-bottom: 0.5em;\n}\n.c-login .btn.hollow {\n  margin-left: 1em;\n}\n.c-login .btn.hollow a {\n  color: #d32323;\n}\n.c-login .invalid-feedback {\n  color: #d32323;\n  padding-bottom: 0.5em;\n}\n.c-login .is-invalid {\n  outline: none;\n  border: 1px solid #d32323;\n  background-color: #fefefe;\n  box-shadow: 0 0 5px #d32323;\n  transition: box-shadow 0.5s, border-color 0.25s ease-in-out;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.login(this.f.emailAddress.value, this.f.password.value)
            ...
            if (typeof data.response != 'undefined') {
                _this.alertType = 'failure';
                _this.alertText = data.message;
            }
            else {
...
module.exports = ".c-signup_container {\n  max-width: 480px;\n  margin: 0 auto;\n}\n@media (max-width: 768px) {\n  .c-signup_container {\n    padding: 3em 20px 0 20px;\n  }\n}\n.c-signup input {\n  margin-bottom: 0.5em;\n}\n.c-signup .btn.hollow {\n  margin-left: 1em;\n}\n.c-signup .btn.hollow a {\n  color: #d32323;\n}\n.c-signup .invalid-feedback {\n  color: #d32323;\n  padding-bottom: 0.5em;\n}\n.c-signup .is-invalid {\n  outline: none;\n  border: 1px solid #d32323;\n  background-color: #fefefe;\n  box-shadow: 0 0 5px #d32323;\n  transition: box-shadow 0.5s, border-color 0.25s ease-in-out;\n}\n.c-signup .form-group button {\n  margin-top: 1.5em;\n}\n::ng-deep dp-date-picker {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var forms_1 = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
var operators_1 = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
var confirmPassword_validator_1 = __webpack_require__(/*! @/validators/confirmPassword.validator */ "./src/app/validators/confirmPassword.validator.ts");
var formatPassword_validator_1 = __webpack_require__(/*! @/validators/formatPassword.validator */ "./src/app/validators/formatPassword.validator.ts");
var user_service_1 = __webpack_require__(/*! @/services/user.service */ "./src/app/services/user.service.ts");
var authentication_service_1 = __webpack_require__(/*! @/services/authentication.service */ "./src/app/services/authentication.service.ts");
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            firstName: ['', [forms_1.Validators.required, forms_1.Validators.minLength(2), forms_1.Validators.maxLength(100)]],
            lastName: ['', [forms_1.Validators.required, forms_1.Validators.minLength(2), forms_1.Validators.maxLength(100)]],
            emailAddress: ['', [forms_1.Validators.required, forms_1.Validators.email]],
            birthDate: '',
            passwords: this.formBuilder.group({
                password: ['', [forms_1.Validators.required, forms_1.Validators.minLength(6)]],
                confirmPassword: ['', [forms_1.Validators.required]],
            }, { validator: [confirmPassword_validator_1.confirmPasswordValidator, formatPassword_validator_1.passwordFormatValidator] }),
        });
    };
    ...
    Object.defineProperty(SignupComponent.prototype, "passwords", {
        get: function () { return this.registerForm.get('passwords'); },
        enumerable: true,
        configurable: true
    });
...
module.exports = ".v-single_header {\n  text-align: center;\n  padding-bottom: 2em;\n}\n.v-single_header h1 {\n  color: #d32323;\n  margin-bottom: 0;\n  font-size: 2.4rem;\n}\n@media screen and (max-width: 768px) {\n  .v-single_header h1 {\n    font-size: 1.75rem;\n  }\n}\n.v-single_categories {\n  font-size: 1.2rem;\n}\n.v-single_review-count {\n  font-size: 0.75em;\n  color: #7a7777b0;\n}\n.v-single_review-container {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n@media screen and (max-width: 768px) {\n  .v-single_image-container {\n    width: 100%;\n    margin-bottom: 2em;\n  }\n}\n.v-single_main {\n  padding-top: 3em;\n}\n@media screen and (max-width: 768px) {\n  .v-single_main {\n    padding-left: 0;\n  }\n}\n.v-single ul {\n  font-size: 1.2rem;\n  list-style-type: none;\n  margin: 0;\n}\n.v-single ul li {\n  font-size: 1.1rem;\n}\n.v-single h5 {\n  display: inline;\n}\n.v-single hr {\n  margin: 0.5em 0;\n}\n.v-single_hours-head {\n  font-weight: bold;\n  margin-bottom: 1em;\n}\n@media screen and (max-width: 768px) {\n  .v-single_hours-head {\n    font-size: 1.3rem;\n  }\n}\n.v-single_hours-day {\n  font-weight: bold;\n}\n@media screen and (max-width: 900px) {\n  .v-single_hours-day {\n    display: block;\n  }\n}\n.v-single_open {\n  color: #d32323;\n}\n@media screen and (max-width: 768px) {\n  .v-single_open {\n    font-size: 1.3rem;\n  }\n}\n.v-single_open.is_open {\n  color: green;\n}\n.v-single_map {\n  padding-top: 5em;\n}\n.v-single_calendar {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr 1fr 1fr;\n  margin: 2em 0;\n  width: 100%;\n}\n@media screen and (max-width: 1200px) {\n  .v-single_calendar {\n    grid-template-columns: 1fr 1fr 1fr 1fr;\n    margin: 0.75em 0;\n  }\n}\n.v-single_calendar-header {\n  padding: 0.25em;\n  text-align: center;\n  border-bottom: 1px solid #324F17;\n}\n.v-single_calendar-hours {\n  padding: 0.25em;\n  text-align: center;\n  line-height: 1.1;\n}\n.v-single_calendar-day {\n  border-top: 1px solid #324F17;\n  border-bottom: 1px solid #324F17;\n  border-left: 1px solid #324F17;\n  background-color: #d9f0c3;\n}\n@media screen and (max-width: 1200px) {\n  .v-single_calendar-day {\n    border: 1px solid #324F17;\n    border-radius: 5px;\n    margin: 0.25em;\n  }\n}\n.v-single_calendar-day:first-of-type {\n  border-top-left-radius: 5px;\n  border-bottom-left-radius: 5px;\n}\n.v-single_calendar-day:last-of-type {\n  border-top-right-radius: 5px;\n  border-bottom-right-radius: 5px;\n  border-right: 1px solid #324F17;\n}\n.v-single_location-header {\n  font-weight: bold;\n}\n@media screen and (max-width: 768px) {\n  .v-single_location-header {\n    font-size: 1.3rem;\n  }\n}\n.v-single_reviews-container {\n  max-width: 960px;\n  margin: 0 auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SingleBusinessComponent = /** @class */ (function () {
    function SingleBusinessComponent(yelpService, route, lightbox, sanitizer) {
        ...
        this.apiUrl = 'https://www.google.com/maps/embed/v1/place?key=AIzaSyA-O-hGRxxv9Hli_zGc4OqzaiCFYT0f1d8&q=';
        this.weekDays = [
    ...
    SingleBusinessComponent.prototype.setBusiness = function (id) {
        ...
        this.yelpService.getSingle(id).subscribe(function (result) {
            ...
            if (result.hasOwnProperty('hours')) {
                result.hours[0].open.forEach(function (day) {
                    day.start = _this.convert24Hours(day.start);
                    day.end = _this.convert24Hours(day.end);
                    day.day_name = _this.weekDays[day.day]['day_name'];
                    console.log(day);
                    _this.hours.push(day);
                });
    ...
    SingleBusinessComponent.prototype.formatSlideshow = function (photos) {
        var _this = this;
        var modalArray = [];
        modalArray = photos.map(function (photo, index) {
            return ({
                url: photo,
                src: photo,
                thumb: photo,
                clickAction: function () { return _this.popModal(index); }
            });
        });
        return modalArray;
    };
    ...
    SingleBusinessComponent.prototype.convert24Hours = function (time) {
        time = [time.slice(0, 2), ':', time.slice(2)].join('');
        var timeString12hr = new Date('1970-01-01T' + time + 'Z')
            .toLocaleTimeString(undefined, { timeZone: 'UTC', hour12: true, hour: 'numeric', minute: 'numeric' });
    ...
    SingleBusinessComponent.ctorParameters = function () { return [
        { type: yelp_service_1.YelpService },
        { type: router_1.ActivatedRoute },
        { type: ngx_lightbox_1.Lightbox },
        { type: platform_browser_1.DomSanitizer }
    ]; };
    SingleBusinessComponent = tslib_1.__decorate([
        core_1.Component({
...
exports.SingleBusinessComponent = SingleBusinessComponent;
...
var ThingsToDoComponent = /** @class */ (function () {
    ...
    ThingsToDoComponent = tslib_1.__decorate([
        core_1.Component({
